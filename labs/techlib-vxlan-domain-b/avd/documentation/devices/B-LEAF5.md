...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | OOB_MANAGEMENT | oob | MGMT | 172.100.100.122/24 | 172.100.100.1 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_B-SPINE1_Ethernet5 | - | 192.168.0.33/31 | default | 9214 | False | - | - |
| Ethernet2 | P2P_B-SPINE2_Ethernet5 | - | 192.168.0.35/31 | default | 9214 | False | - | - |
| Ethernet3 | P2P_B-SPINE3_Ethernet5 | - | 192.168.0.37/31 | default | 9214 | False | - | - |
| Ethernet4 | P2P_B-SPINE4_Ethernet5 | - | 192.168.0.39/31 | default | 9214 | False | - | - |
...
| Loopback101 | Per-VRF Unique Loopback | PROD | 10.101.101.5/32 |
| Loopback102 | Per-VRF Unique Loopback | DEV | 10.102.102.5/32 |
...
| Net-ID | 49.0001.0010.0100.2005.00 |
| Type | level-2 |
| Router-ID | 1.1.2.5 |
...
```eos
!
ip address virtual source-nat vrf DEV address 10.102.102.5
ip address virtual source-nat vrf PROD address 10.101.101.5
```
