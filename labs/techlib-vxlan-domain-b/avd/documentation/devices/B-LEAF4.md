...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | OOB_MANAGEMENT | oob | MGMT | 172.100.100.121/24 | 172.100.100.1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet7 | SERVER_HostB5_eth1 | access | 70 | - | - | - |
| Ethernet8 | SERVER_HostB4_eth2 | *access | *10 | *- | *- | 8 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_B-SPINE1_Ethernet4 | - | 192.168.0.25/31 | default | 9214 | False | - | - |
| Ethernet2 | P2P_B-SPINE2_Ethernet4 | - | 192.168.0.27/31 | default | 9214 | False | - | - |
| Ethernet3 | P2P_B-SPINE3_Ethernet4 | - | 192.168.0.29/31 | default | 9214 | False | - | - |
| Ethernet4 | P2P_B-SPINE4_Ethernet4 | - | 192.168.0.31/31 | default | 9214 | False | - | - |
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel8 | SERVER_HostB4 | access | 10 | - | - | - | - | - | 0000:0000:0b5a:49f2:dc3b |
...
| --------- | --------------------------- | --------------------------- | ------------ |
| Port-Channel8 | 0000:0000:0b5a:49f2:dc3b | all-active | 0b:5a:49:f2:dc:3b |
...
interface Port-Channel8
   ...
   evpn ethernet-segment
      identifier 0000:0000:0b5a:49f2:dc3b
      route-target import 0b:5a:49:f2:dc:3b
   lacp system-id 0b5a.49f2.dc3b
   spanning-tree portfast
   spanning-tree bpduguard enable
```
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | Globally Unique Address | default | 1.1.2.4/32 |
| Loopback1 | VTEP IP | default | 2.2.2.4/32 |
...
| Net-ID | 49.0001.0010.0100.2004.00 |
| Type | level-2 |
| Router-ID | 1.1.2.4 |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 1.1.2.4:10010 | 10010:10010 | - | - | learned |
| 60 | 1.1.2.4:10060 | 10060:10060 | - | - | learned |
| 70 | 1.1.2.4:10070 | 10070:10070 | - | - | learned |
...
| Sequence | Type | Match | Set | Sub-Route-Map | Continue |
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | - | extcommunity soo 2.2.2.4:1 additive | - | - |
...
| --------- | ---- | -------------------- |
| ECL-EVPN-SOO | permit | soo 2.2.2.4:1 |
