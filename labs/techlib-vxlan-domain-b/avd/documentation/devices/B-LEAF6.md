...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | OOB_MANAGEMENT | oob | MGMT | 172.100.100.123/24 | 172.100.100.1 |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | Globally Unique Address | default | 1.1.2.6/32 |
| Loopback1 | VTEP IP | default | 2.2.2.6/32 |
| Loopback101 | Per-VRF Unique Loopback | PROD | 10.101.101.6/32 |
...
| Net-ID | 49.0001.0010.0100.2006.00 |
| Type | level-2 |
| Router-ID | 1.1.2.6 |
...
| --- | ------------------- | ------------ | -------------- |
| DEV | 1.1.2.6:50002 | connected | IPv4: True<br>Transit: False |
| PROD | 1.1.2.6:50001 | connected | IPv4: True<br>Transit: False |
...
ip address virtual source-nat vrf PROD address 10.101.101.6
```
